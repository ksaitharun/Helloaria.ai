  ...
  return (
    <html lang="en" className={poppins.className}>
      <body className="min-h-screen bg-black text-white relative overflow-x-hidden">
        ...
        {/* Decorative orbs */}
        <div className="fixed top-1/4 right-1/4 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl animate-pulse-slow pointer-events-none" />
        <div className="fixed bottom-1/4 left-1/4 w-96 h-96 bg-rose-500/10 rounded-full blur-3xl animate-pulse-slow pointer-events-none" style={{ animationDelay: '2s' }} />
      </body>
    </html>
  )
}
